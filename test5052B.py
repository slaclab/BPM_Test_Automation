...
oscilloscope_IP_address = "169.254.61.75"
...
out = oscilloscope.ask(":CALCulate:PN1:TRACe1:FUNCtion:INTegral:DATA?")
y = oscilloscope.ask(":CALCulate:AM1:TRACe1:DATA:FDATa?")
x = oscilloscope.ask(":CALCulate:AM1:DATA:XDATa?")

markers = oscilloscope.ask(":CALCulate:AM1:TRACe1:ALLMarker:ACTive?")
print(markers)
...
#return_answer = oscilloscope.read()
...
filename = '5052B_screen_capture.bmp'
...
print('Image capture saved to 5052B_capture.bmp')
